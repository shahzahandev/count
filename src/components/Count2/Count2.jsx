...
const Count2 = () => {
    ...
    return (
        <div className="bg-gray-300 pt-[120px] pb-[120px] overflow-x-hidden">
            ...
            <h1 className="text-4xl font-bold text-purple-700 mt-5">You write :</h1>
                <h3 className=" text-center md:text-3xl font-semibold mt-10 mb-5 md:w-auto w-[330px]">{count}</h3>
                <input
                    value={count}
                    onChange={(e) => setCount(e.target.value)}
                    type="text"
                    className="border-none px-20 py-6 md:mt-10 bg-amber-50 rounded-2xl outline-none text-[16px] font-semibold" />
                <button
                    onClick={() => setCount("")}
