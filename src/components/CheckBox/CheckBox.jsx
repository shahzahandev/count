            ...
            <Container>
                <div>
                    <div className="flex justify-center items-center flex-col mt-10">
                        ...
                        <h1 className="text-4xl font-bold text-purple-700 mt-5">Click the Checkbox</h1>
                        ...
                        >
                          ...
                          />
                          <h3 className=" text-center font-semibold md:text-[24px] text-[16px]">I liked this</h3>
                        </label>
                        <p  className=" text-center font-semibold md:text-[24px] text-[16px]"> You {liked ? 'liked' : 'did not like'} this.</p>
                    </div>
                </div>
            </Container>
        </div>
